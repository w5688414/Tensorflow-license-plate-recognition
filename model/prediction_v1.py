...
from model import license_plate_model_v1
...
class PredictionModel(object):
    ...
    def load_model(self, weight_file):
        model_ = license_plate_model_v1.PlatesModel(self.img_height, self.img_width, self.class_num, self.label_max_length)
...
if __name__ == "__main__":
    ...
    weight_file = os.path.join('/media/data/projects/license_plate/checkpoints_resnet', "16_0.355.h5")
